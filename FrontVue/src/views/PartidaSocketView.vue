...
import TableroSocket from '@/components/TableroSocket.vue';
...
// Nombre del rival extraído de la URL
const rival = route.query.vs;
// Usuario actual desde tu auth o session
const usuario = user.usuario; // Aquí pon el real
